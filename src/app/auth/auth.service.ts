...
export class AuthService {
    ...
    signup(email: string, password: string) {
        return this.http.post<AuthResponseData>( //l'api dice che restituisce l'oggetto definito nell'interfaccia sopra, quindi con gli angolari possiamo indicare che tipo di oggetto verrà restituito
            'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=' + environment.firebaseAPIKey, // La prima parte di link è dove mandare la richiesta(in questo caso all'api che permette di fare il sing in fornita da firebase, la parte dopo "=" è la chiave del nostro db che si prendere dalle impostazioni)
